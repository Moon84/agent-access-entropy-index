...
ZH_SOURCE_FIELDS = {
    ...
    "domain_zh": "行业/领域",
    "platform_zh": "平台/公司",
    "product_or_resource": "产品/资源",
    "country_region": "国家/地区",
    "resource_formats": "可及性类型",
    "source_format": "来源类型",
    "source_url": "官方/证据URL",
    "official_status_zh": "官方性状态",
    "verification_status": "复核状态",
    "official_cli": "CLI证据",
    "official_skill": "Skill证据",
    "official_mcp": "MCP证据",
    "official_sdk_api": "SDK/API证据",
    "openness_level": "开放程度",
    "risk_level": "风险等级",
    "description_zh": "备注",
    "source_dataset": "导入批次",
...
EN_SOURCE_FIELDS = {
    ...
    "domain_en": "domain",
    "platform_en": "platform_or_company",
    "product_or_resource": "product_or_resource",
    "country_region": "country_region",
    "resource_formats": "access_types",
    "source_format": "source_type",
    "source_url": "official_or_evidence_url",
    "official_status_en": "official_status",
    "verification_status": "review_status",
    "official_cli": "cli_evidence",
    "official_skill": "skill_evidence",
    "official_mcp": "mcp_evidence",
    "official_sdk_api": "sdk_api_evidence",
